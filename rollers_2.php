...
<head>
    ...
    <link href="css_style/rollers_2.css" rel="stylesheet" type="text/css">
</head>
<body>
<div class="container">
  <div class="row">
    ...
    <div class="catalog">
        ...
        <div class="first">
             <a href="product.php?product_type=rollers&model_id=18" target="blanck">
                <article class="good">
                  <figure class="good-img">
                    <img src="image/rollers/18_1.jpg" alt="">
                  </figure>
                  <div class="good-info">
                    <h3 class="title">MAXCITY SPARK ФИОЛЕТОВЫЙ</h3>
             ...
             <a href="product.php?product_type=rollers&model_id=19" target="blanck">
                <article class="good">
                  <figure class="good-img">
                    <img src="image/rollers/19_1.jpg" alt="">
                  </figure>
                  <div class="good-info">
                    <h3 class="title">MAXCITY PUNTO СИНИЙ</h3>
                    <span class="cost">2 000 руб.</span>
                  </div>
                </article>
              </a>
                
              <a href="product.php?product_type=rollers&model_id=20" target="blanck" id="item_3" style="border-right: 2px solid #F6F6F6; ">
                <article class="good">
                  <figure class="good-img">
                    <img src="image/rollers/20_1.jpg" alt="">
                  </figure>
                  <div class="good-info" >
                    <h3 class="title">Женские Roces Vidi</h3>
                    <span class="cost">15 499 руб.</span>
                  </div>
                </article>
              </a>
              </div>
