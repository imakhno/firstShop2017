...
<head>
    ...
    <link href="css_style/rockets_2.css" rel="stylesheet" type="text/css">
</head>
<body>
<div class="container">
  <div class="row">
        <div class="col-md-12">
            ...
            <section class="container-fluid">
                <div class="promo-text">
                    ...
                    <p class="description">Показано 18-23 товаров из 23</p>
                </div>
            </section>
    ...
    <div class="catalog">
        ...
        <div class="first">
             <a href="product.php?product_type=rockets&model_id=18" target="blanck">
                <article class="good">
                  <figure class="good-img">
                    <img src="image/rockets/18_1.jpg" alt="">
                  </figure>
                  <div class="good-info">
                    <h3 class="title">HEAD MARIA 25</h3>
                    <span class="cost">1 890 руб.</span>
                  </div>
                </article>
              </a>


             <a href="product.php?product_type=rockets&model_id=19" target="blanck">
                <article class="good">
                  <figure class="good-img">
                    <img src="image/rockets/19_1.jpg" alt="">
                  </figure>
                  <div class="good-info">
                    <h3 class="title"> WILSON BLADE 104</h3>
                    <span class="cost">9 700 руб.</span>
                  </div>
                </article>
              </a>
                
              <a href="product.php?product_type=rockets&model_id=20" target="blanck" id="item_3" style="border-right: 2px solid #F6F6F6; ">
                <article class="good">
                  <figure class="good-img">
                    <img src="image/rockets/20_1.jpg" alt="">
                  </figure>
                  <div class="good-info" >
                    <h3 class="title">Wilson Pro Staff Six.One Tour 100</h3>
            ...
            <div class="second">
              <a href="product.php?product_type=rockets&model_id=21" target="blanck">
                <article class="good">
                  <figure class="good-img">
                    <img src="image/rockets/21_1.jpg" alt="">
                  </figure>
                  <div class="good-info">
                    <h3 class="title">Head Titanium 1000 Gr2</h3>
                    <span class="cost">1 370 руб.</span>
                  </div>
                </article>
              </a>

              <a href="product.php?product_type=rockets&model_id=22" target="blanck">
                <article class="good">
                  <figure class="good-img">
                    <img src="image/rockets/22_1.jpg" alt="">
                  </figure>
                  <div class="good-info">
                    <h3 class="title">Lady G033A</h3>
                    <span class="cost">340 руб.</span>
                  </div>
                </article>
              </a>

              <a href="product.php?product_type=rockets&model_id=23" target="blanck" id="item_6" style="border-right: 2px solid #F6F6F6;">
                <article class="good">
                  <figure class="good-img">
                    <img src="image/rockets/23_1.jpg" alt="" >
                  </figure>
                  <div class="good-info">
                    <h3 class="title">Head MX Ice Tour Gr2</h3>
                    <span class="cost">3 932 руб.</span>
                  </div>
                </article>
              </a>
             </div>
