...
<head>
    ...
    <link href="css_style/scooters_2.css" rel="stylesheet" type="text/css">
</head>
<body>
<div class="container">
  <div class="row">
    ...
    <div class="catalog">
        ...
        <div class="first">
             <a href="product.php?product_type=scooters&model_id=18" target="blanck">
                <article class="good">
                  <figure class="good-img">
                    <img src="image/scooters/18_1.jpg" alt="">
                  </figure>
                  <div class="good-info">
                    <h3 class="title">Explore LEADER</h3>
             ...
             <a href="product.php?product_type=scooters&model_id=19" target="blanck">
                <article class="good">
                  <figure class="good-img">
                    <img src="image/scooters/19_1.jpg" alt="">
                  </figure>
                  <div class="good-info">
                    <h3 class="title">Explore Voltage Green</h3>
                    <span class="cost">2 890 руб.</span>
                  </div>
                </article>
              </a>
                
              <a href="product.php?product_type=scooters&model_id=20" target="blanck" id="item_3" style="border-right: 2px solid #F6F6F6; ">
                <article class="good">
                  <figure class="good-img">
                    <img src="image/scooters/20_1.jpg" alt="">
                  </figure>
                  <div class="good-info" >
                    <h3 class="title">Explore Rapler green</h3>
